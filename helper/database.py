...
DB_NAME = os.environ.get("DB_NAME", "mongodb+srv://Tamilbots:tamilbots@cluster0.aa2e1nd.mongodb.net/?retryWrites=true&w=majority")
DB_URL = os.environ.get("DB_URL", "Tamilbots")
